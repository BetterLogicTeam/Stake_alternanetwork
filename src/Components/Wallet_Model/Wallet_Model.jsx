...
export default function Wallet_Model({isModalOpen,handleCancel,setIsModalOpen}) {
    ...
    <div>
      ...
      >
        <div id="WEB3_CONNECT_MODAL_ID">
          <div
            className="sc-jRQBWg VgIbA web3modal-modal-lightbox"
            offset={0}
            opacity="0.4"
          >
            <div className="sc-gKclnd hURhkl web3modal-modal-container">
              <div className="sc-iCfMLu fFpYRP web3modal-modal-hitbox" />
              <div className="sc-furwcr jTJuEI web3modal-modal-card">
                <div className="sc-eCImPb ecAYPs web3modal-provider-wrapper">
                  <div className="sc-hKwDye eSDlbf web3modal-provider-container"  onClick={()=>{dispatch(connectWalletAction(2),setIsModalOpen(false))}}>
                    <div className="sc-bdvvtL fqonLZ web3modal-provider-icon">
                      <img
                    ...
                    <div className="sc-gsDKAQ jRszaI web3modal-provider-name">
                      MetaMask
                    </div>
                    <div className="sc-dkPtRN kCRCOV web3modal-provider-description">
                      Connect to your MetaMask Wallet
                    </div>
                  </div>
                </div>
                <div className="sc-eCImPb ecAYPs web3modal-provider-wrapper">
                  <div className="sc-hKwDye eSDlbf web3modal-provider-container"    onClick={()=>{dispatch(connectWalletAction(1),setIsModalOpen(false))}} >
                    <div className="sc-bdvvtL fqonLZ web3modal-provider-icon">
                      <img
